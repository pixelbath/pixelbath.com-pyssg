...
<img alt="Isometric games" src="/images/isometric-pixel-art/ch1-isometric-games.png" />
...
- [**Aseprite**](https://www.aseprite.org/) - $14.99 - all platforms, absolutely worth the price if you're serious at all about pixel art
- [**Grafx2**](http://grafx2.chez.com/) - free and open source 256-color drawing program inspired by Deluxe Paint for the Amiga
- [**LibreSprite**](https://libresprite.github.io/) - free and open-source - all platforms, a fork of Aseprite that's similar but behind in features
- [**Piskel**](https://www.piskelapp.com/) - free sprite editor available through your browser
- [**Pixen**](https://pixenapp.com/) - free, $9.99 to unlock all features - macOS and iOS only
- [**Pixquare**](https://www.pixquare.art/) - $19.99 - iPhone and iPad only, under active development
...
<div class="image-caption aligncenter">
<img alt="Optical illusions - If this text is being read to you, the feeling of viewing an optical illusion is like the combined sound of two harmonized tones resonating in different ways depending on which tone you focus on" src="/images/isometric-pixel-art/ch1-depth-cues.png" />
