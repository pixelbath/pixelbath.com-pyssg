...
As an example: Google Maps. They've gone ahead and done Street View, brought in GIS data and added 3D models to cities. While we arguably benefit from better Google Maps, the real beneficiary is Google. At that point, they're also the gatekeeper of that information. Why go to another site when Google Maps has it right there?

What happens if Google penalizes a business for some reason? If they're delisted from Google search results or Maps, they would effectively cease to exist for anybody who didn't want to drive to that business's physical location and check for themselves.

Moving on from this specific example, there are other rich datasets that could be useful in the real world, but don't exist for whatever reason. Waymo, Uber, and other companies focusing on autonomous driving collect detailed LIDAR data every day of operation along with detailed footage and data about road conditions. Facebook generated a huge social graph 
